...
static const char col_gray3[]       = "#D3869B";
...
static const char *upvol[]      = { "wpctl",   "set-volume", "f1",      "5%+",      NULL };
static const char *downvol[]    = { "wpctl",   "set-volume", "f2",      "5%-",      NULL };
static const char *mutevol[]    = { "wpctl",   "set-mute",   "f3",      "toggle",   NULL };
