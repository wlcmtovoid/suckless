...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:size=7.5:style=Bold" };
...
static const char *upvol[]      = { "/usr/bin/wpctl",   "set-volume", "51",      "5%+",      NULL };
static const char *downvol[]    = { "/usr/bin/wpctl",   "set-volume", "51",      "5%-",      NULL };
